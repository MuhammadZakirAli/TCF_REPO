...
public class PaintingForm extends AppCompatActivity  {
    ...
    //sprinner string
   // String sccjali_sf,sccjali_ss,sccjali_st;
            ;
    ...
    Button btnSubmitPainting;
    DatabaseReference dbpaintingform;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parapet_wall=findViewById(R.id.p_parapet_wall);
        boundry_wall=findViewById(R.id.p_boundary_wall);
        drive_way=findViewById(R.id.p_drive_way);
        walk_way=findViewById(R.id.p_walkway);
        roof=findViewById(R.id.p_roof);
        column=findViewById(R.id.p_column);
        beam=findViewById(R.id.p_beam);
        wall=findViewById(R.id.p_wall);
        wood_trusses=findViewById(R.id.p_wood_trusses);
        steel_trusses=findViewById(R.id.p_steel_trusses);

        btnSubmitPainting= findViewById(R.id.paintingSubmit);

        cc_jali_f=findViewById(R.id.pccjali_f);
        cc_jali_s=findViewById(R.id.pccjali_s);
        cc_jali_t=findViewById(R.id.pccjali_t);
        low_wall_f=findViewById(R.id.plow_wall_f);
        low_wall_s=findViewById(R.id.plow_wall_s);
        low_wall_t=findViewById(R.id.plow_wall_t);
        staircase_f=findViewById(R.id.p_staircase_f);
        staircase_s=findViewById(R.id.p_staircase_s);
        staircase_t=findViewById(R.id.p_staircase_t);
        parapet_wall_f=findViewById(R.id.p_parapet_wall_f);
        parapet_wall_s=findViewById(R.id.p_parapet_wall_s);
        parapet_wall_t=findViewById(R.id.p_parapet_wall_t);
        boundry_wall_f=findViewById(R.id.p_boundary_wall_f);
        boundry_wall_s=findViewById(R.id.p_boundary_wall_s);
        boundry_wall_t=findViewById(R.id.p_boundary_wall_t);
        drive_way_f=findViewById(R.id.p_drive_way_f);
        drive_way_s=findViewById(R.id.p_drive_way_s);
        drive_way_t=findViewById(R.id.p_drive_way_t);
        walk_way_f=findViewById(R.id.p_walkway_f);
        walk_way_s=findViewById(R.id.p_walkway_s);
        walk_way_t=findViewById(R.id.p_walkway_t);
        roof_f=findViewById(R.id.p_roof_f);
        roof_s=findViewById(R.id.p_roof_s);
        roof_t=findViewById(R.id.p_roof_t);
        column_f=findViewById(R.id.p_column_f);
        column_s=findViewById(R.id.p_column_s);
        column_t=findViewById(R.id.p_column_t);
        beam_f=findViewById(R.id.p_beam_f);
        beam_s=findViewById(R.id.p_beam_s);
        beam_t=findViewById(R.id.p_beam_t);
        wall_f=findViewById(R.id.p_wall_f);
        wall_s=findViewById(R.id.p_wall_s);
        wall_t=findViewById(R.id.p_wall_t);
        wood_trusses_f=findViewById(R.id.p_wood_trusses_f);
        wood_trusses_s=findViewById(R.id.p_wood_trusses_s);
        wood_trusses_t=findViewById(R.id.p_wood_trusses_t);
        steel_trusses_f=findViewById(R.id.p_steel_trusses_f);
        steel_trusses_s=findViewById(R.id.p_steel_trusses_s);
        steel_trusses_t=findViewById(R.id.p_steel_trusses_t);
        cc_jali_dis=findViewById(R.id.pccjali_dis);
        low_wall_dis=findViewById(R.id.plow_wall_dis);
        staircase_dis=findViewById(R.id.p_staircase_dis);
        parapet_wall_dis=findViewById(R.id.p_parapet_wall_dis);
        boundry_wall_dis=findViewById(R.id.p_boundary_wall_dis);
        drive_way_dis=findViewById(R.id.p_drive_way_dis);
        walk_way_dis=findViewById(R.id.p_walkway_dis);
        roof_dis=findViewById(R.id.p_roof_dis);
        column_dis=findViewById(R.id.p_column_dis);
        beam_dis=findViewById(R.id.p_beam_dis);
        wall_dis=findViewById(R.id.p_wall_dis);
        wood_trusses_dis=findViewById(R.id.p_wood_trusses_dis);
        steel_trusses_dis=findViewById(R.id.p_steel_trusses_dis);
        ...
        cc_jali_sf=findViewById(R.id.pccjali_sf);
        ...
        cc_jali_ss=findViewById(R.id.pccjali_ss);
        ...
        cc_jali_st=findViewById(R.id.pccjali_st);
        ...
        cc_jali_pri=findViewById(R.id.pccjali_pri);
        ...
        low_wall_sf=findViewById(R.id.plow_wall_sf);
        ...
        low_wall_ss=findViewById(R.id.plow_wall_ss);
        ...
        low_wall_st=findViewById(R.id.plow_wall_st);
        ...
        low_wall_pri=findViewById(R.id.plow_wall_pri);
        ...
        staircase_sf=findViewById(R.id.p_staircase_sf);
        ...
        staircase_ss=findViewById(R.id.p_staircase_ss);
        ...
        staircase_st=findViewById(R.id.p_staircase_st);
        ...
        staircase_pri=findViewById(R.id.p_staircase_pri);
       ...
       // assigning parapet_wall_sf spinner
        ...
        parapet_wall_sf=findViewById(R.id.p_parapet_wall_sf);
        ...
        parapet_wall_ss=findViewById(R.id.p_parapet_wall_ss);
        ...
        parapet_wall_st=findViewById(R.id.p_parapet_wall_st);
        ...
        parapet_wall_pri=findViewById(R.id.p_parapet_wall_pri);
        ...
        boundry_wall_sf=findViewById(R.id.p_boundary_wall_sf);
        ...
        boundry_wall_ss=findViewById(R.id.p_boundary_wall_ss);
        ...
        boundry_wall_st=findViewById(R.id.p_boundary_wall_st);
        ...
        boundry_wall_pri=findViewById(R.id.p_boundary_wall_pri);
        ...
        drive_way_sf=findViewById(R.id.p_drive_way_sf);
        ...
        drive_way_ss=findViewById(R.id.p_drive_way_ss);
        ...
        drive_way_st=findViewById(R.id.p_drive_way_st);
        ...
        drive_way_pri=findViewById(R.id.p_drive_way_pri);
        ...
        walk_way_sf=findViewById(R.id.p_walkway_sf);
        ...
        walk_way_ss=findViewById(R.id.p_walkway_ss);
        ...
        walk_way_st=findViewById(R.id.p_walkway_st);
        ...
        walk_way_pri=findViewById(R.id.p_walkway_pri);
        ...
        roof_sf=findViewById(R.id.p_roof_sf);
        ...
        roof_ss=findViewById(R.id.p_roof_ss);
        ...
        roof_st=findViewById(R.id.p_roof_st);
        ...
        roof_pri=findViewById(R.id.p_roof_pri);
        ...
        column_sf=findViewById(R.id.p_column_sf);
        ...
        column_ss=findViewById(R.id.p_column_ss);
        ...
        column_st=findViewById(R.id.p_column_st);
        ...
        column_pri=findViewById(R.id.p_column_pri);
        ...
        beam_sf=findViewById(R.id.p_beam_sf);
        ...
        beam_ss=findViewById(R.id.p_beam_ss);
        ...
        beam_st=findViewById(R.id.p_beam_st);
        ...
        beam_pri=findViewById(R.id.p_beam_pri);
        ...
        wall_sf=findViewById(R.id.p_wall_sf);
        ...
        wall_ss=findViewById(R.id.p_wall_ss);
        ...
        wall_st=findViewById(R.id.p_wall_st);
        ...
        wall_pri=findViewById(R.id.p_wall_pri);
        ...
        wood_trusses_sf=findViewById(R.id.p_wood_trusses_sf);
        ...
        wood_trusses_ss=findViewById(R.id.p_wood_trusses_ss);
        ...
        wood_trusses_st=findViewById(R.id.p_wood_trusses_st);
        ...
        wood_trusses_pri=findViewById(R.id.p_wood_trusses_pri);
        ...
        steel_trusses_sf=findViewById(R.id.p_steel_trusses_sf);
        ...
        steel_trusses_ss=findViewById(R.id.p_steel_trusses_ss);
        ...
        steel_trusses_st=findViewById(R.id.p_steel_trusses_st);
        ...
        steel_trusses_pri=findViewById(R.id.p_steel_trusses_pri);
        steel_trusses_pri.setAdapter(adpt_steel_trusses_pri);


        btnSubmitPainting.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                sp_steel_trusses_sf,sp_steel_trusses_ss,sp_steel_trusses_st,sp_steel_trusses_pri;
        ...
        try {
            String id=dbpaintingform.push().getKey();
            paintingFormData paintingData=new paintingFormData(id,ccjali,slow_wall,sstaircase,sparapet_wall,sboundry_wall,sdrive_way,swalk_way,sroof,scolumn,sbeam,swall,swood_trusses,ssteel_trusses);
            dbpaintingform.child(id).setValue(paintingData);
    ...
    //setting ccjali 1st floor spinner value
